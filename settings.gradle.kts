...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("structurizr-export", "com.structurizr", "structurizr-export").version("1.16.0")
            library("structurizr-client", "com.structurizr", "structurizr-client").version("1.26.1")
